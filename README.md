...
In order for our code to be consistent, there is a linter implemented in the project that runs on each push which modifies a `.py` file.
...
These are the rules which we apply to our code. A short breakdown would be:
