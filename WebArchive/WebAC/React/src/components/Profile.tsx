      ...
      <div style={{ marginTop: 12, display: 'grid', gap: 12 }}>
        ...
        <div className="bp-box" style={{ display: 'grid', gap: 10 }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <div style={{ display: 'flex', gap: 8 }}>
              <button className="bp-add-btn" onClick={deactivate2FA} style={{ padding: '8px 12px' }}>Dezactivate</button>
            </div>
          </div>
          ...
          {pendingActivation && (
            <div style={{ marginTop: 8, display: 'grid', gap: 8 }}>
              ...
              <div style={{ display: 'flex', gap: 8 }}>
                ...
                <button className="bp-add-btn" onClick={cancelActivation}>Cancel</button>
              </div>
            </div>
          )}
