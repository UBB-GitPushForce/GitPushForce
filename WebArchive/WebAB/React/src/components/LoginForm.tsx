        ...
        return (
            <>
                ...
                <div style={{ display: 'flex', gap: 8, marginTop: 12 }}>
                    <button className="bp-add-btn" onClick={submit2FA} disabled={loading || !twoFactorCode}>Verify</button>
                        <button className="bp-add-btn" onClick={resendCode} disabled={sendingAgain}>
                        {sendingAgain ? 'Resending...' : 'Resend code'}
                    </button>
                        <button className="bp-add-btn" onClick={() => cancelTwoFactor()}>
                        Cancel
                    </button>
                </div>
    ...
    return (
        <>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <button className="bp-add-btn" type="submit" disabled={loading}>
