  ...
  return (
    <div style={{ marginTop: 12, display: 'flex', flexDirection: 'column', gap: 12 }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div style={{ fontWeight: 800, fontSize: 20, color: 'var(--text-dark)' }}>AI Assistant</div>
        <div style={{ display: 'flex', gap: 8 }}>
          <button className="btn" onClick={clearConversation} style={{ background: 'transparent', color: 'var(--purple-1)', border: '1px solid rgba(0,0,0,0.08)' }}>
            Clear
          </button>
        </div>
      </div>
