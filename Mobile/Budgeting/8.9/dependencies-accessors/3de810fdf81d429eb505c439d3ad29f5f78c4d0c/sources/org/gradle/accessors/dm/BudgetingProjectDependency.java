...
@NonNullApi
public class BudgetingProjectDependency extends DelegatingProjectDependency {

    @Inject
    public BudgetingProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
